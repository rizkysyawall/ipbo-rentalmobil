 ...
 * @author Me
 */
public class Controller_LapPelanggan {
    ...
    public void cetak_excel()
    {
        try
        {
            Connection conn = Koneksi.Database.KoneksiDB();
            String path = "src/Report/LapPelanggan.jasper";
            File xlsx = new File("C:/Kampus/LapPelanggan.xlsx");
            ...
            JOptionPane.showMessageDialog(null, "Cek File pada Drive D:/LAPORAN/LapPelanggan.xlsx");
        }
        catch (Exception ex)
        {
            JOptionPane.showMessageDialog(null, "Data Tidak Dapat Dicetak !! " + ex.getMessage(), "Cetak Data", JOptionPane.ERROR_MESSAGE);
